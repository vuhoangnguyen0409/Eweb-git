   ...
   while ( have_posts() ) :
        the_post();?>
				<p class="half-float">
					<b>
						<?php the_title(); ?>
					</b><span><i class="circle"></i><a href="<?php echo home_url( "/" ); ?>service#<?php echo get_the_ID(); ?>"><?php the_post_thumbnail(); ?></a></span>
					<b>
						<?php the_title(); ?>
					</b>
				</p>
...
if ( have_posts() ):
   while ( have_posts() ) :
        the_post();?>
				<p><span><i class="circle"></i><a href="<?php echo home_url( "/" ); ?>service#<?php echo get_the_ID(); ?>"><?php the_post_thumbnail(); ?></a></span>
					<b>
						<?php the_title(); ?>
					</b>
				</p>
